...
#define ARG1FNS FN1ARGDELTA,FN1ARGSUM,FN1ARGPOSTSUM,FN1ARGPRESUM,FN1ARGAVG,FN1ARGMIN,FN1ARGMAX,FN1ARGCOUNT,FN1ARGONRATIO,FN1ARGNORATIO
#define ARG1STRS @"change_in", @"sum", @"post-sum", @"pre-sum", @"avg", @"min", @"max", @"count", @"old/new", @"new/old"
#define ARG1CNT 10
