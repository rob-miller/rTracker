...
- (void) openMail:(NSString*)btnTitle {
    ...
    if ([emEmailCsv isEqualToString:btnTitle]) {
        if ([rTracker_resource getRtcsvOutput]) {
            emailBody = [self.tracker.trackerName stringByAppendingString:@" tracker data file in rtCSV format attached.  Generated by <a href=\"http://www.realidata.com/cgi-bin/rTracker/iPhone/rTracker-main.pl\">rTracker</a>."];
        } else {
