...
@property (nonatomic, unsafe_unretained, readonly) UIImage *backgroundImage;
...
@property (nonatomic, unsafe_unretained, readonly) UIImage *selectedBackgroundImage;
...
@property (nonatomic, unsafe_unretained, readonly) UIImage *todayBackgroundImage;
...
@property (nonatomic, unsafe_unretained, readonly) UIImage *notThisMonthBackgroundImage;
